...
/**
 * Defines field 25519 function based on <a href=
 * "https://github.com/agl/curve25519-donna/blob/master/curve25519-donna.c">curve25519-donna
 * C implementation</a> (mostly identical).
 *
 * <p>
 * Field elements are written as an array of signed, 64-bit limbs (an array of
 * longs), least significant first. The value of the field element is:
 *
 * <pre>
...
final class Field25519 {
    /**
     * During Field25519 computation, the mixed radix representation may be in
     * different forms:
     * <ul>
     * <li>Reduced-size form: the array has size at most 10.
     * <li>Non-reduced-size form: the array is not reduced modulo 2^255 - 19 and has
     * size at most 19.
     * </ul>
     */
    ...
    static void reduceSizeByModularReduction(long[] output) {
        // The coefficients x[10], x[11],..., x[18] are eliminated by reduction modulo
        // 2^255 - 19.
        // For example, the coefficient x[18] is multiplied by 19 and added to the
        // coefficient x[8].
        //
    ...
    /**
     * Takes a fully reduced mixed radix form number and contract it into a
