...
/**
 * Defines <a href="https://cr.yp.to/ecdh/curve25519-20060209.pdf">the ECDH
 * Curve25519 function</a>, also known as the X25519 function.
 *
 * <p>
 * This implementation is based on <a href=
 * "https://github.com/agl/curve25519-donna/blob/master/curve25519-donna.c">curve255-donna</a>.
 *
 * <h3>Warning</h3>
 *
 * <p>
 * Do not use this API or any other APIs including fields and methods marked
 * with the @Alpha annotation. They can be modified in any way, or even removed,
 * at any time. They are in the package, but not for official, production
 * release, but only for testing.
 *
 * <h3>Usage</h3>
 *
 * <pre>
...
public final class X25519 {
     ...
     * a valid implementation of computeSharedSecret should throw away the exact
     * same bits anyway.
     */
     ...
     * @throws InvalidKeyException when {@code privateKey} is not 32-byte or
     *                             {@code peersPublicValue} is invalid.
     */
