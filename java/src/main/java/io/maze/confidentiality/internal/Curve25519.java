 ...
 * <a href="https://cr.yp.to/ecdh/curve25519-20060209.pdf">Curve25519</a>.
 *
 * <p>
 * This class only implements point arithmetic, if you want to use the ECDH
 * Curve25519 function, please checkout
 * {@link com.google.crypto.tink.subtle.X25519}.
 *
 * <p>
 * This implementation is based on <a href=
 * "https://github.com/agl/curve25519-donna/blob/master/curve25519-donna.c">curve255-donna
 * C implementation</a>.
 */
final class Curve25519 {
    // https://cr.yp.to/ecdh.html#validate doesn't recommend validating peer's
    // public key. However,
    // validating public key doesn't harm security and in certain cases, prevents
    // unwanted edge
    // cases.
    // As we clear the most significant bit of peer's public key, we don't have to
    // include public keys
    ...
    static final byte[][] BANNED_PUBLIC_KEYS = new byte[][] {
            ...
            // 1
            new byte[] { (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                    (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                    (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                    (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                    (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, },
            // 325606250916557431795983626356110631294008115727848805560023387167927233504
            new byte[] { (byte) 0xe0, (byte) 0xeb, (byte) 0x7a, (byte) 0x7c, (byte) 0x3b, (byte) 0x41, (byte) 0xb8,
                    (byte) 0xae, (byte) 0x16, (byte) 0x56, (byte) 0xe3, (byte) 0xfa, (byte) 0xf1, (byte) 0x9f,
                    (byte) 0xc4, (byte) 0x6a, (byte) 0xda, (byte) 0x09, (byte) 0x8d, (byte) 0xeb, (byte) 0x9c,
                    (byte) 0x32, (byte) 0xb1, (byte) 0xfd, (byte) 0x86, (byte) 0x62, (byte) 0x05, (byte) 0x16,
                    (byte) 0x5f, (byte) 0x49, (byte) 0xb8, (byte) 0x00, },
            // 39382357235489614581723060781553021112529911719440698176882885853963445705823
            new byte[] { (byte) 0x5f, (byte) 0x9c, (byte) 0x95, (byte) 0xbc, (byte) 0xa3, (byte) 0x50, (byte) 0x8c,
                    (byte) 0x24, (byte) 0xb1, (byte) 0xd0, (byte) 0xb1, (byte) 0x55, (byte) 0x9c, (byte) 0x83,
                    (byte) 0xef, (byte) 0x5b, (byte) 0x04, (byte) 0x44, (byte) 0x5c, (byte) 0xc4, (byte) 0x58,
                    (byte) 0x1c, (byte) 0x8e, (byte) 0x86, (byte) 0xd8, (byte) 0x22, (byte) 0x4e, (byte) 0xdd,
                    (byte) 0xd0, (byte) 0x9f, (byte) 0x11, (byte) 0x57 },
            // 2^255 - 19 - 1
            new byte[] { (byte) 0xec, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x7f, },
            // 2^255 - 19
            new byte[] { (byte) 0xed, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x7f },
            // 2^255 - 19 + 1
            new byte[] { (byte) 0xee, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff,
                    (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x7f } };
    ...
    private static void monty(long[] x2, long[] z2, long[] x3, long[] z3, long[] x, long[] z, long[] xprime,
        ...
        // and {@ref
        // Field25519#product} adds together, at most, 14 of those products.
        // (Approximating that to
        ...
        // |zzz[i]| < 2^(27+17)
        // No need to call reduceSizeByModularReduction here: scalarProduct doesn't
        // increase the degree
        // of its input.
     ...
     * @param qBytes  a little endian, 32-byte number representing the public point'
     *                x coordinate.
     * @throws InvalidKeyException   iff the public key is in the banned list or its
     *                               length is not 32-byte.
    ...
    static void curveMult(long[] resultx, byte[] n, byte[] qBytes) throws InvalidKeyException {
        ...
        // Nowadays it should be standard to protect public key crypto against flaws.
        // I.e. if there is a
        // computation error through a faulty CPU or if the implementation contains a
        // bug, then if
        // possible this should be detected at run time.
        //
        // The situation is a bit more tricky for X25519 where for example the
        // implementation
        // proposed in https://tools.ietf.org/html/rfc7748 only uses the x-coordinate.
        // However, a
        // verification is still possible, but depends on the actual computation.
        //
        // Tink's Java implementation is equivalent to RFC7748. We will use the loop
        // invariant in the
        // Montgomery ladder to detect fault computation. In particular, we use the
        // following invariant:
        // q, resultx, nqpqx/nqpqx are x coordinates of 3 collinear points q, n*q, (n +
        // 1)*q.
     ...
     *
     * @throws InvalidKeyException iff the {@code pubKey} is in the banned list or
     *                             its length is not 32-byte.
     */
    private static void validatePubKeyAndClearMsb(byte[] pubKey) throws InvalidKeyException {
        if (pubKey.length != 32) {
            throw new InvalidKeyException("Public key length is not 32-byte");
        }
        // Clears the most significant bit as in the method decodeUCoordinate() of
        // RFC7748.
        pubKey[31] &= (byte) 0x7f;
    ...
    /**
     * Checks whether there are three collinear points with x coordinate x1, x2,
     * x3/z3.
     *
     * @return true if three collinear points with x coordianate x1, x2, x3/z3 are
     *         collinear.
     */
    private static boolean isCollinear(long[] x1, long[] x2, long[] x3, long[] z3) {
        // If x1, x2, x3 (in this method x3 is represented as x3/z3) are the
        // x-coordinates of three
        ...
        // y^2 = (a - A)x^2 + (1 - B)x - C
        // This is a quadratic curve. Three distinct collinear points can only be on a
        // quadratic
        // curve if the quadratic curve has a line as component. And if a quadratic
        // curve has a line
        ...
        //
        // * If x1 and x2 are both points with y-coordinate 0 then the argument doesn't
        // hold.
        ...
        //
        // * x1, x2 or x3/y3 may be points on the twist. If so, they satisfy the
        // equation
        // 2y^2 = x^3 + ax^2 + x
        // Hence, the three points also satisfy
